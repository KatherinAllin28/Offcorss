...
En la práctica, esto serviría para que un empleado escriba: “El inventario del SKU 1234 está bajo, genera compra de 150 unidades” y el agente entienda la intención, cree la orden de compra y la ingrese sin intervención humana, lo cual reduce el tiempo de trabajo y la efectividad en este ya que así como recibe este comando puede recibir otros como `.\.venv\Scripts\python.exe reto4_demo.py "Cliente 9987 solicita copia de la factura 456-2024 y estado de envío."`,`.\.venv\Scripts\python.exe reto4_demo.py "Registrar pedido del cliente 887 por 30 unidades del producto 1123."`, `.\.venv\Scripts\python.exe reto4_demo.py "Cliente 221 reporta prenda defectuosa en pedido 441."` y `.\.venv\Scripts\python.exe reto4_demo.py "Generar reporte semanal de devoluciones y ventas online."`, entre otros.
